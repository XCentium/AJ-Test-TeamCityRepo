...
AS
	...
	BEGIN
		...
		DECLARE @RC int
				...
				EXECUTE	@RC = [dbo].[sp_AddDataRefreshStatus] @JobId = 2, @JobName = 'Product', @JobDB = N'ETL', 
				...
				--EXECUTE	@RC = [dbo].[sp_AddDataRefreshStatus] @JobId = 2, @JobName = 'Product', @JobDB = N'Insite', 
				--											  @JobStatus = N'Completed',	@ErrorMessage = N''
