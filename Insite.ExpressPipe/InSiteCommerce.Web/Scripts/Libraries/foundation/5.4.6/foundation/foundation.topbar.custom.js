			...
			$(this.scope)
			  ...
			  .on('click.fndtn.topbar', '.top-bar .has-dropdown>a', function (e) {
			  	...
			  	if (self.breakpoint()) {
			  		...
			  		if (topbar.find(".moved").length != topbar.data('index') + 1) { //this detects a double click on the same li and prevents us from sliding the top-bar too far to the left
			  			return;
			  		}
